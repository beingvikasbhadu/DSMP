...
@Repository
public class MarkdownAppDAOImpl  {
    
	private final MarkdownAppDAO markdownAppDAO;

	@Autowired
	public MarkdownAppDAOImpl(MarkdownAppDAO markdownAppDAO) {
	    this.markdownAppDAO = markdownAppDAO;
	}
	...
	public NoteBean getNoteByIdFromDb(int id) {
